...
import 'package:mints/core/services/imageService.dart';
import 'package:mints/ui/pages/create_comic.dart';
import 'package:mints/ui/pages/create_comic2.dart';
import 'package:mints/ui/pages/feed.dart';
import 'package:mints/ui/pages/sec.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  AppBar _appbar(int index) {
    List<String> _pagetitles = ['mints', 'New Comic', 'Profile'];
    return AppBar(
      title: Text(
        _pagetitles[index],
